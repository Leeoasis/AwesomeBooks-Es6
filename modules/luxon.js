...
class DateTime {
  ...
  /**
    ...
    * @example DateTime.local(2014, 7, 13).toSQL({ includeZone: true }) //=>
    * '2014-07-13 00:00:00.000 America/New_York'
    * @return {string}
    */
  toSQL(opts = {}) {
    if (!this.isValid) {
  ...
  /**
    ...
    * { year: 2017, month: 4, day: 22, hour: 20, minute: 49, second: 42, millisecond: 268 }
    * @return {Object}
    */
  toObject(opts = {}) {
    if (!this.isValid) return {};
  ...
  /**
    ...
    * @param {string|string[]} [unit=['milliseconds']] - the unit or array of units
  ...
  /**
    ...
    * @param {string|string[]} [unit=['milliseconds']] - the unit or units units
    * (such as 'hours' or 'days')
    *  to include in the duration
    * @param {Object} opts - options that affect the creation of the Duration
    * @param {string} [opts.conversionAccuracy='casual'] - the conversion system to use
    * @return {Duration}
    */
  ...
  /**
    ...
    * Note that time zones are **ignored** in this comparison,
    *  which compares the **local** calendar time. Use {@link DateTime#setZone}
    *  to convert one of the dates if needed.
    * @param {DateTime} otherDateTime - the other DateTime
    * @param {string} unit - the unit of time to check sameness on
    * @example DateTime.now().hasSame(otherDT, 'day'); //~> true if otherDT
    * is in the same current calendar day
    * @return {boolean}
    */
  ...
  /**
    * Returns a string representation of a this time relative to now,
    *  such as "in two days". Can only internationalize if your
    * platform supports Intl.RelativeTimeFormat. Rounds down by default.
    * @param {Object} options - options that affect the output
    * @param {DateTime} [options.base=DateTime.now()] - the DateTime to use as the
    *  basis to which this time is compared. Defaults to now.
    * @param {string} [options.style="long"] - the style of units,
    *  must be "long", "short", or "narrow"
    * @param {string|string[]} options.unit - use a specific unit or array of units;
    * if omitted, or an array, the method will pick the best unit.
    *  Use an array or one of "years", "quarters", "months", "weeks", "days", "hours", "minutes", or "seconds"
    * @param {boolean} [options.round=true] - whether to round the numbers in the output.
    * @param {number} [options.padding=0] - padding in milliseconds.
    *  This allows you to round up the result if it fits inside the threshold.
    *  Don't use in combination with {round: false} because the decimal output will include the padding.
    * @param {string} options.locale - override the locale of this DateTime
    * @param {string} options.numberingSystem - override the numberingSystem of this DateTime.
  ...
  /**
    * Returns a string representation of this date relative to today, such as "yesterday" or
    *  "next month".
    ...
    *  Use one of "years", "quarters", "months", "weeks", or "days"
    * @param {string} options.numberingSystem - override the numberingSystem of this DateTime.
    *  The Intl system may choose not to honor this
  ...
  /**
    ...
    *  format like '09:30:23 AM Eastern Daylight Time'.
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like '10/14/1983, 9:30 AM'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like '10/14/1983, 9:30:33 AM'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like 'Oct 14, 1983, 9:30 AM'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like 'Oct 14, 1983, 9:30:33 AM'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like 'Fri, 14 Oct 1983, 9:30 AM'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    *  format like 'October 14, 1983, 9:30 AM EDT'.
    *  Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    * format like 'October 14, 1983, 9:30:33 AM EDT'.
    * Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    * format like 'Friday, October 14, 1983, 9:30 AM Eastern Daylight Time'.
    * Only 12-hour if the locale is.
    * @type {Object}
    */
  ...
  /**
    * {@link DateTime#toLocaleString}
    * format like 'Friday, October 14, 1983, 9:30:33 AM Eastern Daylight Time'.
    * Only 12-hour if the locale is.
    * @type {Object}
    */
